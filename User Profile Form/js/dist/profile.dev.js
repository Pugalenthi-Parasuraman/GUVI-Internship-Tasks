...
var populateProfileFields = function populateProfileFields() {
...
var setProfileFields = function setProfileFields(profile) {
...
var fetchProfileData = function fetchProfileData(email) {
  ...
  $.ajax({
    type: "GET",
    url: "".concat(backendUrl, "/profile.php"),
    data: {
      email: email
    },
    dataType: "json",
    ...
    error: function error(xhr, status, _error) {
      ...
      alert("An error occurred while fetching your profile data. Please try again.");
    }
  });
};

var handleProfileFormSubmit = function handleProfileFormSubmit(event, token) {
  var backendUrl = "https://fond-generally-stag.ngrok-free.app/Task%201/php";
